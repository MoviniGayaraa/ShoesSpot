...
import bannermens from "./assets/background/banner9.jpeg";
import bannerwomens from "./assets/background/banner7.png";
import bannerkids from "./assets/background/baby1.jpg";
