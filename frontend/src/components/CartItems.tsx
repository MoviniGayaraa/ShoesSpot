        ...
        <section className="max_padd_container pt-28">
            ...
            <div className="flex flex-col gap-20 my-16 p-8 mg:flex-row rounded-md bg-white w-full max-w-[666px]">
                <div className="flex flex-col gap-10">
                    ...
                    <button className="btn_light_rounded w-44"></button>
                    <div className="flwx flex-col gap-10">
                        <h4 className="bold-20 capitalize">Thanks for Shopping with Us!</h4>
                        <div className="flexBetween pl-5 h-12 bg-primary rounded-full ring-1 ring-slate-900/10">
                            <input type="text" placeholder="Happy Shopping!" className="bg-transparent border-none outline-none"/>
                            <button className="btn_light_rounded"></button>
                        </div>
                    </div>
                </div>
            </div>
