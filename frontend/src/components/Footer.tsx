...
import logofooter from "../assets/logo/footer-logo1.png"

function Footer() {
  return (
    <footer className="text-black body-font bg-black">
      <div className="container px-5 py-10 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <div className="flex flex-col items-start pl-12 py-5">
            <img src={logofooter} height={70} width={80} />
            {/* <span className="ml-3 text-xl">ShopCarts</span> */}
          </div>
          <p className="mt-2 text-sm text-[#fafafa] pl-10">
            Shop the latest trends in Daily Luxe. Fast
