      ...
      <div className="flex flex-col gap-14 xl:flex-row">
        ...
        <div className="flex-col flex xl:flex-[1.7]">
          ...
          <div className="flex gap-x-6 medium-20 my-4">
            ...
            <div className="mb-4">
                <h4 className="bold-16">Available Sizes</h4>
            ...
            <div className="flex flex-col gap-y-3 mb-4 max-w-[555px]">
                ...
                <button className="btn_dark_rounded !rounded-none uppercase regular-14 tracking-widest">Pick It Up and Enjoy
                </button>
            </div>
            <p><span className="medium-16 text-tertiary">Category :</span> {product.category} | Shoe | Sustainable Materials</p>
            <p><span className="medium-16 text-tertiary"></span></p>
        </div>
      </div>
    </section>
  );
